...
Alert.prototype = {	
	...
	getTemplate: function() {
		...
		this.content.className = 'default'+' '+this.addClassName;
	...
	setPosition: function(obj){
		//obj.content.innerHTML!=''&&obj.content.innerText!=''
	...
	show: function(options) {
		...
		this.addClassName = this.args.addClassName || ' ';
		this.callBack = {};
		...
		// }
		var _this = this;	
		this.showInterval = setInterval(function(){_this.setPosition(_this);_this.reset();},'300')	
